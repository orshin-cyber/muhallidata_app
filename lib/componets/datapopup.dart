                ...
                return InkWell(
                  onTap: () {
                    Navigator.pop(context, {
                      "text":
                          "${_searchResult[index]['plan']}  ${widget.plan[index]['plan_type'] == null ? '' : widget.plan[index]['plan_type']}   -   ₦${_searchResult[index]['plan_amount']} ${_searchResult[index]['month_validate']}",
              ...
              itemBuilder: (context, index) {
                return InkWell(
                  onTap: () {
                    Navigator.pop(context, {
                      "text":
                          "${widget.plan[index]['plan']}  ${widget.plan[index]['plan_type'] == null ? '' : widget.plan[index]['plan_type']}   -   ₦${widget.plan[index]['plan_amount']} ${widget.plan[index]['month_validate']}",
                  ...
                  child: Container(
                    ...
                    child: Text(
                      "${widget.plan[index]['plan']}  -   ₦${widget.plan[index]['plan_amount']} ${widget.plan[index]['month_validate']}",
                      style:
                          TextStyle(fontSize: 18, fontWeight: FontWeight.w400),
                    ),
                  ),
