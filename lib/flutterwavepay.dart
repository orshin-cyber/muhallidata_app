...
class _FlutterwavePayState extends State<FlutterwavePay> {
  ...
  Future<dynamic> paymentgateway(amount) async {
    ...
    try {
      ...
      Response response = await post(Uri.parse(url),
              ...
              body: jsonEncode(
                  {"amount": int.parse(amount), "medium": "monnify"}))
  ...
  Widget _entryField(String title, myicon, mykey, String inputvalue,
      ...
      {required dynamic valid, bool isPassword = false}) {
    return Container(
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: Color.fromRGBO(164, 6, 7, 1),
          boxShadow: <BoxShadow>[
            BoxShadow(
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.of(context).pushAndRemoveUntil(
                      MaterialPageRoute(
                          builder: (BuildContext context) => FlutterwavePay()),
