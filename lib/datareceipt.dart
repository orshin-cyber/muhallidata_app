...
class DataReceipt extends StatefulWidget {
  Map data;
  DataReceipt({required this.data});
...
class _DataReceiptState extends State<DataReceipt> {
  ...
  Future<void> generateExampleDocument() async {
   ...
   <!DOCTYPE html>
    <html>
     ...
     <center>  <h2> muhallidata Data Subscription Receipt</h2></center>  
  ...
  <tr>
      <td><b>Response</b></td>
      <td id ="api_response">${widget.data['api_response']}</td>
  </tr>
